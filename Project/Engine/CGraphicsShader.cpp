...
void CGraphicsShader::CreateVertexShader(const wstring& _strFileName, const string& _strFuncName)
{
	...
	LayoutDesc[1].AlignedByteOffset = sizeof(float) * count;
	...
	LayoutDesc[2].AlignedByteOffset = sizeof(float) * count;;
	...
	LayoutDesc[3].AlignedByteOffset = sizeof(float) * count;;
	...
	LayoutDesc[4].AlignedByteOffset = sizeof(float) * count;;
